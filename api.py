...
app.include_router(features.recipes.ingredients.ingredients_router, prefix='/ingredients')
app.include_router(features.recipes.ingredients.category_router, prefix='/ingredients/categories')
